...
import { followUser, unfollowUser, getUserFollowData } from '../controllers/followingsController.js';
...
usersRoute.get('/:userId/follow-data', logThis('Getting follow data'), requireToken, validateUserId, validateVisitedUserId, getUserFollowData);

usersRoute.post('/:followed_id/follow', logThis('Follow user'), requireToken, validateUserId, verifyIfUserIsFollowed, followUser);
usersRoute.post('/:followed_id/unfollow', logThis('Unfollow user'), requireToken, validateUserId, verifyIfUserIsFollowed, unfollowUser);
