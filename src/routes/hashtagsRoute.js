...
router.get('/:hashtag/posts', logThis('Get hashtags posts'), requireToken, validateUserId, validateHashtag, checkGetSharesQuery, getHashtagData);
router.get('/:hashtag/posts/check', logThis('Check hashtag posts'), requireToken, validateUserId, validateHashtag, checkCheckSharesQuery, checkHashtagShares);
